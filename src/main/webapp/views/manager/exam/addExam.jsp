            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form">
                        ...
                        <button type="button" class="btn btn-success" id="add_exam_btn"><i class="glyphicon glyphicon-plus"></i> 新增</button>
                    </form>
                </div>
            </div>
...
<script>
    ...
    function addExam(jsonData){
        $.ajax({
            url:"${APP_PATH}/exam/addExam",
            data:jsonData,
            type:"post",
            beforeSend:function () {
