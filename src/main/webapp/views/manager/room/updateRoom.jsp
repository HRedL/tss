...
<script >
    ...
    function initUpdatePage() {
        var id= $("#id").val();
        $.ajax({
            url:"${APP_PATH}/room/initUpdateRoom",
            type:"get",
            data:{
                "id":id
            },
            ...
            success:function(result) {
                ...
                var room=result.body.room;
                $("input[name=room_rnum]").val(room.rnum);
                $("input[name=room_capacity]").val(room.capacity);
                $("input[name=room_ttotalnum]").val(room.ttotalnum);

                campusBind(room.building.campus);
                buildingBind(room.building.campus,room.building.id);
            }
        });
    }
    ...
    function updateRoom(jsonData){
        $.ajax({
            url:"${APP_PATH}/room/update",
            data:jsonData,
            type:"post",
            beforeSend:function () {
