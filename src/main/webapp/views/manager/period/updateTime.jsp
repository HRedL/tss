...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <ol class="breadcrumb">
                <li><a href="<c:url value="/views/manager/period/manageTime.jsp"/>">时间管理</a></li>
    ...
    function updateTime(jsonData) {
        $.ajax({
            ...
            success:function(result) {
                ...
                window.location.href="${APP_PATH}/views/manager/period/manageTime.jsp";
            }
        });
    }
