                  ...
                  <li style="padding-top:8px;">
                      <div class="btn-group">
                          ...
                          <ul class="dropdown-menu" role="menu">
                              ...
                              <li>
                                  <a href="${PATH}/views/sysmanager/common/sendMsg.jsp"><i class="glyphicon glyphicon-comment"></i>消息</a>
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <section ui-type="index-banner" class="index-banner ">
                <div class="container"> <div class="group">
                    ...
                    <p></p><p>EAS考试排考系统，采用智能化的算法实现排考功能，致力于用更简便的方式对考试相关事务进行组织安排，满足教师和学生查询相关考次的需求，减轻排考老师负担。
                </p><p></p>
                    <div class="btn">
                        <a href="whole.jsp">系统帮助文档</a>
                    </div>
                </div>
                </div>
            </section>
                        ...
                        <div class="block-wraper-col3">
                            <article data-ui-index="0" style="height: 152px;">
                                <div class="head">
                                    ...
                                    <span class="title">系统管理员模块功能</span>
                                    <a href="" target="_blank"></a>
                                </div>
                                <div class="detail-content">
                                    <ul>
                                        <li>系统管理员可以使用户管理菜单查看、修改、删除用户数据</li>
                                        <li>系统管理员可以使用反馈消息管理菜单查看、回复用户反馈的问题</li>
                                    </ul>
                                </div>
                            </article>
                        </div>
