...
<%--显示发送消息的模态框--%>
<div class="modal fade" tabindex="-1" role="dialog" id="write_modal1">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">接收人</label>
                        <div class="col-sm-10">
                            <select class="form-control" name="type1" style="width:300px;" id="write_feedback_answerUser1">
                                <option value="001">监考管理员</option>
                                <option value="0001">系统管理员</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">主题</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="write_feedback_title1" placeholder="15个字以内">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">问题</label>
                        <div class="col-sm-10">
                            <textarea class="form-control" id="write_feedback_question1" placeholder="100个字以内"></textarea>
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="writeFeedback_btn1">添加</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<jsp:include page="teacherTitle.jsp"/>
        ...
        <div class="col-sm-3 col-md-2 sidebar">
            <div class="tree">
                <ul style="padding-left:0px;" class="list-group">
                    ...
                    <li class="list-group-item tree-closed">
                        <span><a href="#" id="writeMessage1"><i class="glyphicon glyphicon-pencil"></i>反馈</a></span>
                    </li>
                    <li class="list-group-item tree-closed">
                    ...
                    <li class="list-group-item tree-closed" >
                        <a href="${APP_PATH}/views/teacher/teacherMain.jsp"><i class="glyphicon glyphicon-share-alt"></i>返回教师界面</a>
                    </li>
...
<script type="text/javascript">
    ...
    $("#writeMessage1").click(function(){
        $("#write_modal1").modal('show');
    });
    ...
    function getReplyMessageQuery(pageNumber){
        ...
        $.ajax({
            ...
            success:function(result) {
                ...
                pageInf+='<li><a href="#" onclick="getUpdateFeedback(1)">首页</a></li>';
                if(pageInfo.hasPreviousPage){
                    pageInf+='<li><a href="#" onclick="getUpdateFeedback('+(pageNumber-1)+')">上一页</a></li>';
                }
                ...
                $.each(pageInfo.navigatepageNums,function (index,item) {
                    if(item==pageNumber){
                        ...
                        pageInf+='<li><a href="#" onclick="getUpdateFeedback('+item+')">'+item+'</a></li>';
                    }
                });

                if(pageInfo.hasNextPage){
                    pageInf+='<li><a href="#" onclick="getUpdateFeedback('+(pageNumber+1)+')">下一页</a></li>';
                }
                pageInf+='<li><a href="#" onclick="getUpdateFeedback('+pageInfo.pages+')">末页</a></li>';
    ...
    $("#writeFeedback_btn1").click(function(){
        var questionUserLogname= $("#logname").html();
        var answerUserLogname= $("#write_feedback_answerUser1").val();
        var title= $("#write_feedback_title1").val();
        var question= $("#write_feedback_question1").val();
        $.ajax({
            url:"${APP_PATH}/feedback/sendFeedback",
            type:"post",
            data:{
